...
mkdir pub
echo -e "Google Container Registry Mirror\n\n-------\n\n[![Sync Status](https://api.travis-ci.org/anjia0532/gcr.io_mirror.svg?branch=sync)](https://travis-ci.org/anjia0532/gcr.io_mirror)\n\nTotal of ${#imgs[@]}'s gcr.io images\n\n-------\n\nUseage\n\n-------\n\n\`\`\`bash\ndocker pull gcr.io/google-containers/federation-controller-manager-arm64:v1.3.1-beta.1 \n# eq \ndocker pull anjia0532/federation-controller-manager-arm64:v1.3.1-beta.1\n\`\`\`\n\nImages\n\n-------\n\n" > pub/README.md
